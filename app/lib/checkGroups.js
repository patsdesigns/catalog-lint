...
const FAMILY_LIST = [
  ...
  { id: "vendor_type", label: "Vendor and product type", category: "organization" },
  { id: "tags_collections", label: "Tags and collections", category: "organization" },
  { id: "weight", label: "Weight", category: "shipping" },
  { id: "variants", label: "Variants", category: "variants" },
  { id: "seo", label: "SEO title and meta description", category: "seo" },
